# Future Features - Design Document

**Status:** 📋 Planning / Design Phase
**Current Implementation:** Bot Framework with UI (see IMPLEMENTATION_SUMMARY.md)
**This Document:** Roadmap for advanced features

## Overview

This document outlines **future enhancements** to add advanced MCP features to Telegram Desktop that would complement the Python MCP server. These features are not yet implemented but represent the next phase of development.
