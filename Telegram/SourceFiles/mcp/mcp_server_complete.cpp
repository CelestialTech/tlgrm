...
bool Server::start(TransportType transport) {
	...
	// Create MCP-specific tables
	{
		...
		q.exec("CREATE TABLE IF NOT EXISTS achievement_claims (achievement_id TEXT PRIMARY KEY, claimed_at TEXT DEFAULT (datetime('now')), progress_at_claim INTEGER)");
...
void Server::initializeToolHandlers() {
	...
	_toolHandlers["get_full_user"] = [this](const QJsonObject &args) { return toolGetFullUser(args); };
	_toolHandlers["resolve_phone"] = [this](const QJsonObject &args) { return toolResolvePhone(args); };
	_toolHandlers["get_message_views"] = [this](const QJsonObject &args) { return toolGetMessageViews(args); };
	_toolHandlers["get_peer_stories"] = [this](const QJsonObject &args) { return toolGetPeerStories(args); };
	_toolHandlers["get_all_stories"] = [this](const QJsonObject &args) { return toolGetAllStories(args); };
	...
	_toolHandlers["send_location"] = [this](const QJsonObject &args) { return toolSendLocation(args); };
	_toolHandlers["send_venue"] = [this](const QJsonObject &args) { return toolSendVenue(args); };
	_toolHandlers["send_contact"] = [this](const QJsonObject &args) { return toolSendContact(args); };
	_toolHandlers["send_dice"] = [this](const QJsonObject &args) { return toolSendDice(args); };
	_toolHandlers["send_photo"] = [this](const QJsonObject &args) { return toolSendPhoto(args); };
	_toolHandlers["send_gif"] = [this](const QJsonObject &args) { return toolSendGif(args); };
	_toolHandlers["send_audio"] = [this](const QJsonObject &args) { return toolSendAudio(args); };
	_toolHandlers["send_poll"] = [this](const QJsonObject &args) { return toolSendPoll(args); };
	_toolHandlers["vote_poll"] = [this](const QJsonObject &args) { return toolVotePoll(args); };
	_toolHandlers["get_poll_results"] = [this](const QJsonObject &args) { return toolGetPollResults(args); };
	_toolHandlers["mute_chat"] = [this](const QJsonObject &args) { return toolMuteChat(args); };
	_toolHandlers["get_chat_notify_settings"] = [this](const QJsonObject &args) { return toolGetChatNotifySettings(args); };
	_toolHandlers["save_draft"] = [this](const QJsonObject &args) { return toolSaveDraft(args); };
	_toolHandlers["clear_all_drafts"] = [this](const QJsonObject &args) { return toolClearAllDrafts(args); };
	_toolHandlers["get_contacts"] = [this](const QJsonObject &args) { return toolGetContacts(args); };
	_toolHandlers["add_contact"] = [this](const QJsonObject &args) { return toolAddContact(args); };
	_toolHandlers["delete_contact"] = [this](const QJsonObject &args) { return toolDeleteContact(args); };
	_toolHandlers["import_contacts"] = [this](const QJsonObject &args) { return toolImportContacts(args); };
	_toolHandlers["get_discussion_message"] = [this](const QJsonObject &args) { return toolGetDiscussionMessage(args); };
	_toolHandlers["get_message_read_participants"] = [this](const QJsonObject &args) { return toolGetMessageReadParticipants(args); };
	_toolHandlers["ban_chat_member"] = [this](const QJsonObject &args) { return toolBanChatMember(args); };
	_toolHandlers["unban_chat_member"] = [this](const QJsonObject &args) { return toolUnbanChatMember(args); };
	_toolHandlers["send_bot_start"] = [this](const QJsonObject &args) { return toolSendBotStart(args); };
